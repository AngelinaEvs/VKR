...
/* package-private */
internal class GpuBuffer constructor(target: Int, numberOfBytesPerEntry: Int, entries: Buffer?) {
    ...
    init {
        ...
        try {
            ...
            GLES30.glBindBuffer(target, bufferId.get(0))
    ...
    companion object {
        private val TAG: String = GpuBuffer::class.java.getSimpleName()
