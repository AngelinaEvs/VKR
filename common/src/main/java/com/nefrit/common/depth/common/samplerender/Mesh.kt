...
import com.nefrit.common.depth.common.samplerender.IndexBuffer
...
class Mesh constructor(
    ...
    fun lowLevelDraw() {
        ...
        if (indexBuffer == null) {
            ...
            val vertexCount: Int = vertexBuffers.get(0).numberOfVertices
            for (i in 1 until vertexBuffers.size) {
                val iterCount: Int = vertexBuffers.get(i).numberOfVertices
