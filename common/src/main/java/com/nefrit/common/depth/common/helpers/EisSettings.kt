 ...
 */
package com.nefrit.common.depth.common.helpers
...
class EisSettings {
    ...
    companion object {
        const val SHARED_PREFERENCE_ID = "SHARED_PREFERENCE_EIS_OPTIONS"
        const val SHARED_PREFERENCE_EIS_ENABLED = "eis_enabled"
    }
}